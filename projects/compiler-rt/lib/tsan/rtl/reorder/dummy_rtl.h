...
void nop_cond_wait(__tsan::ThreadState *thr, uptr pc, u64 addr_cond,
                   u64 addr_mtx) {}
...
void nop_mem_acc(ThreadState *thr, uptr pc, uptr addr, int kAccessSizeLog,
                 bool is_write) {}

void nop_mem_acc_line(ThreadState *thr, uptr pc, uptr addr, int kAccessSizeLog,
                      bool is_write, u32 line, char *file) {}

// 7
// 8 + (13 + 48) + 32 = 104
void nop_mem_range_acc(__tsan::ThreadState *thr, uptr pc, uptr addr, uptr size,
                       bool is_write) {}

void nop_thread_created(int tid_parent, int tid_kid, uptr pc) {}

void nop_thread_start(__tsan::ThreadState *thr, uptr stk_addr, uptr stk_size,
...
void nop_ptr_prop(__tsan::ThreadState *thr, uptr pc, uptr addr_src,
                  uptr addr_dest) {}

void nop_order(ThreadState *thr, uptr pc, u32 orderType, u32 line, char *file) {
}
